...
Our project is a music app named Dotify that allows you to find new music based on different 
search filters that we offer. Currently our app allows User's to log in their account and enjoy from a music selection putgether by our team and hope to expand our collection through the use of music database API's.
